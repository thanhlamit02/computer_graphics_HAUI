...
color4 light_ambient(0.2, 0.2, 0.2, 1.0); // anh sang môi truong
color4 light_diffuse(1.0, 1.0, 1.0, 1.0); // anh sang khuyech tan
color4 light_specular(1.0, 1.0, 1.0, 1.0); // anh sang phan chieu sagn choi
...
void TrucCau()
{
	...
	khuan_may_cau(cd_dau_may_cau / 2, cc_thung_hang_may_cau, cr_dau_may_cau / 2, red);// 
